 ...
 *                bob is capped at HEAD_BOB_MAX and can be switched off entirely (`bobEnabled`)."
...
describe('BUG · bobEnabled does not disable the shake (vision §12 "toggleable bob/shake")', () => {
  /**
   * movement.ts:850 gates ONLY `bobY` on `bobEnabled`. The landing dip (:843-847) and the slide
...
describe('PIN · the rig respects the vision §12 comfort floor', () => {
  ...
  it('caps head bob at HEAD_BOB_MAX and really does stop when bobEnabled is false', () => {
