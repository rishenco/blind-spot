...
export class PlayerController {
  ...
  /**
   * Points the head at a heading without moving the body — the keyframe generator's way of
   * steering, since synthetic mouse drags are not reproducible.
   */
  setHeading(yawDeg: number, pitchDeg = 0): void {
  ...
  /**
   * Eye point in world space — the simulation-side head position (no render bob or dip).
   * Returned in a shared scratch vector: read it, don't keep it.
   */
